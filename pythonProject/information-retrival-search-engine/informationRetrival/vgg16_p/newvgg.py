...
def readvector():
    open_file = h5py.File('/home/do/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/test.h5', 'r')
    vector = open_file['test'][:]
    open_file.close()
    return vector

def getTitleCheck_VGG():
    a = np.load('/home/do/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/classification/title_check.npy', allow_pickle= True)
    return a.item()
...
def compare():
    ...
    # 取样本
    image_sample = Image.open("/home/do/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/frontend/static/frontend/images/temp.jpg")
...
def compare_melanger():
    ...
    model = VGG16(weights='imagenet', include_top=False)
    # 取样本
    image_sample = Image.open("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/frontend/static/frontend/images/temp.jpg") # 此处添加修改地址
    imageS = image_sample.crop()
    thisImage = imageS.resize((224, 224))
    my_image = image.img_to_array(thisImage)
    my_x = np.expand_dims(my_image, axis=0)
