...
def compare_melanger():
    ...
    model = VGG16(weights='imagenet', include_top=False)
    # 取样本
    image_sample = Image.open("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/frontend/static/frontend/images/ob_0513bb_8f651a6ec72dd4528e1f6a948b323558.jpg") # 此处添加修改地址
    imageS = image_sample.crop()
    thisImage = imageS.resize((224, 224))
    my_image = image.img_to_array(thisImage)
    my_x = np.expand_dims(my_image, axis=0)
...
def res_comparer(img_path):
    #model = ResNet50(weights='imagenet')
    model=VGG16(weights='imagenet')
    #img_path = '/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/frontend/static/frontend/images/temp.jpg'
    #img_path="/home/ubuntu/Images/ob_0513bb_8f651a6ec72dd4528e1f6a948b323558.jpg"
    #img = image.load_img(img_path, target_size=(224, 224))
    img= img_path.resize((224, 224), Image.ANTIALIAS)
...
def main():
    ...
    FILE_PATH = "/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/frontend/static/frontend/json"
    ...
    fr = open("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/informationRetrival/frontend/static/frontend/json/movie_100.json","r")
    # print(movie)
    # print(movie_id)
    movie_model = json.load(fr)
    fr.close()
...
def res():
    for i in range(1,100):
        f=open("/home/ubuntu/Desktop/oumar/"+str(i)+'.txt','r')
        d=f.read()
        d=ast.literal_eval(d)
        IMAGE_BASE_PATH = "https://image.tmdb.org/t/p/w500"
        if d['poster_path']:
            img_path = IMAGE_BASE_PATH + d['poster_path']
            html = requests.get(img_path, verify=False)
            print("ok")
            poster = Image.open(BytesIO(html.content))
            poster_img = poster.crop()
            ...
            poster_img.show()
        print(d)
#(id:292539 OR id:16288 OR id:1961 OR id:13158 OR id:415 OR id:1924 OR id:16281 OR id:9824 OR id:414 OR id:26
