...
if __name__ == '__main__':
    f='/home/ubuntu/Desktop/oumar'
    g="/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/index"
    #get_movie(datetime.now(),f)
    index=Indexing(g)

    file_pa=get_file_path(f,"1.txt")
    c=MovieData(file_pa)

    print("new")

    print(c.data_ast)
    index.index_doc(file_pa,"1.txt")
    index.write_single_index(file_pa)
    crawl_and_update(datetime.now(),f,g )
