...
class Indexing:
    ...
    def __init__(self, index_folder, create=False):
        if not os.path.exists("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/index"):
            os.mkdir("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/index")
            self.ix = index.create_in(
                "/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/index",
                self.get_schema())
        # if creating a new index
        if create:
            self.ix = index.create_in("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/index", self.get_schema())
        # if adding to existing index
        else:
            self.ix = index.open_dir("/home/ubuntu/PycharmProjects/pythonProject/information-retrival-search-engine/index")
